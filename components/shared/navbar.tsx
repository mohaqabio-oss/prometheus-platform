  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-white/10 bg-[#0A0F1D]/85 backdrop-blur-xl transition-all duration-300 shadow-2xl">
      <div className="container mx-auto flex h-20 items-center justify-between px-4 sm:px-6 md:px-8">
        ...
        {/* Right CTA Actions - Pure Links without nested Button elements */}
        <div className="hidden md:flex items-center gap-3">
          <Link
            href="/login"
            className="inline-flex items-center justify-center font-medium gap-2 border border-white/15 bg-white/5 text-white hover:text-[#E84A0C] hover:border-[#E84A0C]/40 text-xs rounded-xl h-8 px-3 transition-all duration-300 backdrop-blur-md cursor-pointer select-none"
          >
          ...
          <Link
            href="/join-us"
            className="inline-flex items-center justify-center font-medium text-xs bg-[#E84A0C] hover:bg-[#D03E06] text-white rounded-xl h-8 px-3 shadow-lg transition-all duration-300 hover:scale-105 cursor-pointer select-none"
          >
            تقديم طلب انضمام
          </Link>
        </div>
        ...
        <div className="lg:hidden border-b border-white/10 bg-[#0A0F1D]/98 backdrop-blur-2xl px-6 py-6 space-y-5 animate-fade-in shadow-2xl">
          ...
          <div className="pt-4 border-t border-white/10 flex flex-col gap-2.5">
            <Link
              href="/login"
              onClick={() => setMobileMenuOpen(false)}
              className="w-full inline-flex items-center justify-center font-medium gap-2 text-xs rounded-xl border border-white/15 bg-white/5 text-white hover:text-[#E84A0C] h-9 px-3 transition-all duration-300 cursor-pointer"
            >
              <Shield className="w-3.5 h-3.5 text-[#E84A0C]" />
              <span>دخول الكادر</span>
            </Link>
            <Link
              href="/join-us"
              onClick={() => setMobileMenuOpen(false)}
              className="w-full inline-flex items-center justify-center font-medium text-xs bg-[#E84A0C] hover:bg-[#D03E06] text-white rounded-xl h-9 px-3 shadow-md transition-all duration-300 cursor-pointer"
            >
              تقديم طلب انضمام
            </Link>
          </div>

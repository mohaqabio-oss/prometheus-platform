...
import { Mail, Send, BookOpen, Clock, FileCheck } from "lucide-react";

export const dynamic = "force-dynamic";

export const metadata: Metadata = {
  title: "تواصل مع الهيئة التحريرية | مجلة بروميثيوس الأكاديمية",
  description: "معلومات الاتصال وإيداع الأوراق البحثية والاستفسارات الأكاديمية لمجلة بروميثيوس.",
};

export default async function AcademicContactPage() {
  ...
  return (
    <div className="py-12 sm:py-20 container mx-auto px-4 sm:px-6 md:px-8 max-w-5xl space-y-16 animate-fade-in">
      ...
      {/* Dynamic Header */}
      <SectionHeader
        badgeText="المكتب التحريري"
        title="تواصل مع الهيئة التحريرية وإيداع الأبحاث"
        description="نرحب باستفسارات الباحثين والمؤسسات الأكاديمية بشأن النشر، إيداع المقالات والبحوث، والانضمام لهيئة التحكيم الأكاديمي."
      />
          ...
          <Card className="p-6 bg-[#0D0D0D] border border-[#6B7280]/20 rounded-2xl space-y-6 shadow-xl">
            <div className="space-y-2">
              ...
              <p className="text-xs text-[#6B7280]">
                {contact.officeInfo || "مجلة وفريق بروميثيوس التطوعية - قسم النشر الأكاديمي والبحوث."}
              </p>
            </div>
            ...
            <div className="space-y-4 pt-2">
              ...
              <div className="flex items-start gap-3 text-xs font-sans">
                <div className="p-2 rounded-xl bg-[#1A2B4A] border border-[#6B7280]/30 text-emerald-400">
                  <FileCheck className="w-4 h-4" />
                </div>
                <div>
                  <p className="font-bold text-white">متوسط فترة التحكيم</p>
                  <p className="text-[#6B7280] font-mono mt-0.5">14 - 21 يوم عمل للتحكيم المزدوج</p>
                </div>
              </div>
            </div>
          </Card>
        ...
        <div className="lg:col-span-7">
          <Card className="p-8 bg-[#0D0D0D] border border-[#6B7280]/20 rounded-2xl space-y-6 shadow-xl">
            <div className="space-y-1">
              ...
              <p className="text-xs text-[#6B7280]">
                املأ النموذج وسيقوم منسق التحرير بالرد عليك في غضون 48 ساعة عمل.
              </p>
            </div>
            ...
            <form className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1">
                  <label className="text-xs text-[#6B7280] font-sans">اسم الباحث / المتقدم</label>
                  <Input placeholder="الاسم الأكاديمي الكامل..." className="text-xs" required />
                </div>
                <div className="space-y-1">
                  <label className="text-xs text-[#6B7280] font-sans">البريد الإلكتروني</label>
                  <Input type="email" placeholder="name@university.edu" className="text-xs font-mono" required />
                </div>
              </div>

              <div className="space-y-1">
                <label className="text-xs text-[#6B7280] font-sans">موضوع المراسلة أو عنوان البحث</label>
                <Input placeholder="مثال: إيداع ورقة بحثية في تخصص الذكاء الاصطناعي..." className="text-xs" required />
              </div>

              <div className="space-y-1">
                <label className="text-xs text-[#6B7280] font-sans">تفاصيل المراسلة أو مستخلص البحث</label>
                <textarea
                  rows={5}
                  placeholder="اكتب مستخلص الورقة البحثية أو تفاصيل الاستفسار الأكاديمي..."

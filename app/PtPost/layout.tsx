...
export default function PrometheusPostLayout({
  children,
}: {
    ...
    <div className="min-h-screen flex flex-col bg-[#080C16] text-[#F8FAFC] selection:bg-[#E84A0C] selection:text-white font-sans">
        ...
        <div className="container mx-auto max-w-6xl flex flex-wrap items-center justify-between gap-2">
          <div className="flex items-center gap-3">
            <span className="inline-flex items-center gap-1.5 text-[#E84A0C] font-semibold">
              ...
              مجلة بروميثيوس الأكاديمية المحكمة • Prometheus Post
            </span>
          ...
          <div className="flex items-center gap-4 text-[11px]">
            <Link
              href="/"
              className="hover:text-white transition-colors flex items-center gap-1 text-[#E84A0C] font-mono"
            >
      ...
      <header className="sticky top-0 z-50 w-full border-b border-white/10 bg-[#080C16]/90 backdrop-blur-xl shadow-2xl">
        <div className="container mx-auto max-w-6xl flex h-20 items-center justify-between px-4 sm:px-6">
          ...
          {/* Journal Branding */}
          <Link href="/PtPost" className="flex items-center gap-3.5 group">
          ...
          {/* Sub-navbar Links */}
          <nav className="hidden md:flex items-center gap-6 text-xs font-medium font-sans">
            <Link
              href="/PtPost/articles"
              className="text-stone-300 hover:text-[#E84A0C] transition-colors py-1"
            >
              الأرشيف والمقالات
            </Link>
            <Link
              href="/PtPost/editorial-board"
              className="text-stone-300 hover:text-[#E84A0C] transition-colors py-1"
            >
              الهيئة التحريرية
            </Link>
            ...
            <Link
              href="/"
              className="text-stone-400 hover:text-white transition-colors py-1 font-mono text-[11px]"
            >
        ...
        <div className="md:hidden border-t border-white/5 bg-[#05080F]/95 px-4 py-2.5 flex items-center justify-between text-xs overflow-x-auto gap-4">
          <Link href="/PtPost/articles" className="text-stone-300 hover:text-[#E84A0C] whitespace-nowrap">
            الأرشيف والمقالات
          </Link>
          <Link href="/PtPost/editorial-board" className="text-stone-300 hover:text-[#E84A0C] whitespace-nowrap">
            الهيئة التحريرية
          </Link>
          <Link href="/PtPost/publication-ethics" className="text-stone-300 hover:text-[#E84A0C] whitespace-nowrap">
            سياسات النشر
          </Link>
          <Link href="/" className="text-[#E84A0C] whitespace-nowrap font-mono">
            الموقع الرئيسي ←
          </Link>
        </div>
      </header>
      ...
      <footer className="border-t border-white/10 bg-[#05080F] text-stone-400 py-12 px-4 sm:px-6 mt-20">
        <div className="container mx-auto max-w-6xl space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="md:col-span-2 space-y-4">
              ...
              <p className="text-xs text-stone-400 leading-relaxed max-w-md font-sans">
                دورية علمية محكمة مفتوحة المصدر تعنى بنشر الأوراق والبحوث المنهجية والمراجعات التقنية بإشراف هيئة تحريرية متخصصة.
              </p>
            </div>
            ...
            <div className="space-y-3 text-xs">
              ...
              <ul className="space-y-2 font-sans">
                <li>
                  <Link href="/PtPost/articles" className="hover:text-[#E84A0C] transition-colors">
                    الأرشيف والمقالات الأكاديمية
                  </Link>
                </li>
                <li>
                  <Link href="/PtPost/editorial-board" className="hover:text-[#E84A0C] transition-colors">
                    أعضاء الهيئة التحريرية
                  </Link>
                </li>
                <li>
                  <Link href="/PtPost/publication-ethics" className="hover:text-[#E84A0C] transition-colors">
                    أخلاقيات وسياسات النشر
                  </Link>
                </li>
              </ul>
            </div>
          ...
          <div className="pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between text-xs font-mono text-stone-500 gap-4">
            <p>© {new Date().getFullYear()} مجلة بروميثيوس الأكاديمية (Prometheus Post). ترخيص المشاع الإبداعي CC BY 4.0.</p>
            <Link href="/" className="text-stone-400 hover:text-white transition-colors">
              العودة للموقع الرئيسي pmthiq.online ←
            </Link>
          </div>
        </div>
      </footer>
